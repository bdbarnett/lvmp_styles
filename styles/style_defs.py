...
focused_style.set_outline_color(lv.palette_main(lv.PALETTE.RED))
...
btn_default_style.set_outline_width(2)
...
btn_checked_style = lv.style_t()
btn_checked_style.set_bg_color(lv.palette_main(lv.PALETTE.RED))

btn_pressed_style = lv.style_t()
btn_pressed_style.set_transform_width(-2)
btn_pressed_style.set_transform_height(-2)
